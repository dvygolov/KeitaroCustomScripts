...
class formlocker extends AbstractClickMacro
{
    ...
    <script>
	    function lockform(event){
			...
			form.removeEventListener('submit', lockform);
			...
			ntf.setAttribute('style','width:100%;display:flex;justify-content:center;')
			ntf.innerHTML = '<img src="data:image/png;base64,'+imageBase64+'">'+message;
		...
		function addLocker(){
			...
			for (var i = 0; i < forms.length; i++){
				forms[i].addEventListener('submit', lockform);
			};
	    }
		document.addEventListener('DOMContentLoaded', addLocker);
	</script>
EOT;
    }
}
